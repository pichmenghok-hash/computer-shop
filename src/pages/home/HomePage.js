...
function HomePage(){
   const [name, setMyName] = useState("Sok")
      ...
      <div>
        {/* <h1 className="text-green-800 text-4xl flex justify-center">Home Page</h1>
         ...
         <div> 
            ...
            <h1> Gender: {gender} </h1> 
            <h1> Age: {age} </h1> 
            <button className=" p-[10px] bg-cyan-400 rounded-s" onClick={onChangeInfo}>Chage User info</button>

            <input className="rounded-s border-gray-200 p-[10px]"
